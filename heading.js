    ...
    if (e.matches) {
        ...
        header.innerHTML = `
            ...
            <div id="header-navigation">
                <a class="navigation-option center" href="pages/navigation/realms.html">Realms</a>
                <a class="navigation-option center" href="pages/navigation/seasons.html">Seasons</a>
                <a class="navigation-option center" href="pages/navigation/nations.html">Nations</a>
                <a class="navigation-option center" href="pages/navigation/characters.html">Characters</a>
                <a class="navigation-option center" href="pages/navigation/mechanics.html">Mechanics</a>
            </div>
        `;
    } else {
        ...
        header.innerHTML = `
            ...
            <div class="center" id="header-navigation">
                ...
                <a class="navigation-option center" href="pages/navigation/nations.html">Nations</a>
                <a class="navigation-option center" href="pages/navigation/characters.html">Characters</a>
                <a class="navigation-option center" href="pages/navigation/players.html">Players</a>
                <a class="navigation-option center" href="pages/navigation/mechanics.html">Mechanics</a>
            </div>
            <div id="showcase">${showcaseContent}</div>
        `;
